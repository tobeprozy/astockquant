...
class StockIndicatorsVisualizer:
    ...
    def plot_macd_1():
        ...
        bar_2 = (
            ...
            .add_yaxis(
                series_name="MACD",
                y_axis=self.data['MACD_HIST'].tolist(),
                xaxis_index=2,
                yaxis_index=2,
                label_opts=opts.LabelOpts(is_show=False),
                itemstyle_opts=opts.ItemStyleOpts(
    ...
    def rander_html():
        ...
        # 最下面的柱状图和折线图
        overlap_bar_line = self.plot_macd_1.overlap(self.plot_dif_dea)
